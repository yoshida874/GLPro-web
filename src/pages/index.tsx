  ...
  return (
    <>
      ...
      <Box mr="40" ml="40" mt="10" mb="20">
        <TopCard title="Purpose" subtitle="各地域の総合レビュー" img="bill.png">
          東京、引っ越しの際に東京がどんな場所なのか東京に住んでる方の素直な意見を見ることができ、地域についてのイメージをつかめます
        </TopCard>
        <TopCard title="Review" subtitle="様々な観点からの素直な意見" img="peple.png">
          治安、物価、交通など項目に分けてその地域に住んでる皆さんの様々な意見や感想など確認できます。
        </TopCard>
        <TopCard title="Quesiton" subtitle="疑問を解消する" img="question.png">
